            ...
            <div className="flex flex-col">
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        <h3 className="text-[14vw] sm:text-[12vw] md:text-[10vw] font-bold tracking-[-0.05em] uppercase leading-[0.85] mb-3 md:mb-4 group-hover:px-2 md:group-hover:px-4 duration-500 transition-all ease-out">
                            {service.title}
                        </h3>
